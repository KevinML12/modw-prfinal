...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/checkout" | "/login" | "/orders" | "/product" | "/product/[id]" | "/register" | "/test-auth";
		RouteParams(): {
		...
		Pathname(): "/" | "/checkout" | "/checkout/" | "/login" | "/login/" | "/orders" | "/orders/" | "/product" | "/product/" | `/product/${string}` & {} | `/product/${string}/` & {} | "/register" | "/register/" | "/test-auth" | "/test-auth/";
