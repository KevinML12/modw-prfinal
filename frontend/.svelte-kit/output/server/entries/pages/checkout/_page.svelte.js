...
const CheckoutItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { item } = $$props;
  const currency = (value) => new Intl.NumberFormat("es-MX", { style: "currency", currency: "MXN" }).format(value);
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const currency = (value) => new Intl.NumberFormat("es-GT", { style: "currency", currency: "GTQ" }).format(value);
  let $$settled;
  let $$rendered;
